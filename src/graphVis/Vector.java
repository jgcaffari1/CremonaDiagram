...
/**
 * vector class based off of the nature of code. It allows for vector operations to be performed. It
 * is essentially the same as the PVector class from processing.
 */
public class Vector {
